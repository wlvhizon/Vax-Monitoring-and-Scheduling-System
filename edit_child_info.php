...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateStmt->execute()) {
        echo "<script>alert('Child information updated successfully!'); window.location.href = 'admin.php';</script>";
        $updateStmt->close();
        exit();
    } else {
        echo "<script>alert('Failed to update child information.'); window.location.href = 'admin.php';</script>";
        $updateStmt->close();
        exit();
    }
}
